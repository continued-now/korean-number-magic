...
const Index = () => {
  ...
  return <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-b from-background to-secondary/30 px-4 py-12">
      <div className="w-full max-w-4xl mx-auto">
        <div className="space-y-8 animate-fade-in">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground mt-2 max-w-sm mx-auto">숫자를 입력하면 한글로 변환해 드립니다.</p>
          </div>
          ...
          animationDelay: "0.1s"
            ...
            <NumberInput value={inputValue} onChange={handleInputChange} onNumberChange={handleNumberChange} />
            
            <div className="pt-2">
              <ResultDisplay number={number} onNumberChange={handleNumberChange} className="transition-all duration-500" />
            </div>
          </div>
          
          {/* Examples */}
          <div className="pt-6 space-y-3 animate-slide-up" style={{
          animationDelay: "0.2s"
        }}>
      ...
      {/* Footer */}
      <footer className="mt-16 text-xs text-muted-foreground animate-fade-in" style={{
      animationDelay: "0.3s"
    }}>
